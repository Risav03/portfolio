  ...
  return (
    <div className='w-screen h-52 flex flex-col gap-2 items-center justify-center rounded-t-xl border-t-2 border-green-500 bg-[#08080b] -translate-x-4 md:-translate-x-16'>
        ...
        <div className='flex max-md:flex-col gap-2'>
            ...
            <a href='https://x.com/Risavdeb03' target='_blank' className='font-semibold hover:scale-105 duration-200 flex items-center justify-center w-32 py-2 rounded-xl gap-2 border-[1px] border-green-500'><FaXTwitter/>Twitter</a>
        </div>
    </div>
  )
}
